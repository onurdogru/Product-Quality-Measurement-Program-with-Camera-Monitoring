...
namespace LANDFCT
{
    public class AyarForm : Form
    {
        ...
        private void AyarForm_Load(object sender, EventArgs e)
        {
            ...
            this.SerialPort3Stop.Text = Ayarlar.Default.SerialPort3stopBit.ToString();
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case 0:
                        Ayarlar.Default.SerialPort3stopBit = StopBits.None;
                        break;
                    case 1:
                        Ayarlar.Default.SerialPort3stopBit = StopBits.One;
                        break;
                    case 2:
                        Ayarlar.Default.SerialPort3stopBit = StopBits.Two;
                        break;
                    case 3:
                        Ayarlar.Default.SerialPort3stopBit = StopBits.OnePointFive;
                        break;
                    default:
                        Ayarlar.Default.SerialPort3stopBit = StopBits.One;
                        break;
        ...
        private void InitializeComponent()
        {
            ...
            this.chBoxProgramlama.Visible = false;
            // 
            // groupBox5
            // 
            ...
            this.groupBox9.Location = new System.Drawing.Point(433, 501);
            this.groupBox9.Name = "groupBox9";
            this.groupBox9.Size = new System.Drawing.Size(407, 78);
            this.groupBox9.TabIndex = 679;
